...
class CopyFilesCommand extends Command
{
    ...
    protected $description = 'Copy files from package laravel7acl to this application';
    ...
    public function handle()
    {
        ...
        File::copy(base_path('vendor/ribafs/laravel7-acl/up/User.php'), app_path('User.php'));

        File::copy(base_path('vendor/ribafs/laravel7-acl/up/HomeController.php'), app_path('Http/Controllers/HomeController.php'));
