...
class CopyFilesCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if(File::exists($route)){
            ...
            File::copy(base_path('vendor/ribafs/laravel7-acl/acl/web.php'), base_path('routes/web.php'));
        }
        $wel = base_path('resources/views/welcome.blade.php');
        if(File::exists($wel)){
            File::copy($wel, base_path('resources/views/welcome.bladeBAK.php'));
            File::copy(base_path('vendor/ribafs/laravel7-acl/acl/views/welcome.blade.php'), base_path('resources/views/welcome.blade.php'));
        }
        $app = base_path('resources/views/layouts/app.blade.php');
        if(File::exists($app)){
            File::copy($app, base_path('resources/views/layouts/app.bladeBAK.php'));
            File::copy(base_path('vendor/ribafs/laravel7-acl/acl/views/layouts/app.blade.php'), base_path('resources/views/layouts/app.blade.php'));
        }
